...
namespace Bundox.Core
{
    public static class LuceneSearch
    {
        ...
        private static Analyzer _createAnalyzer()
        {
        ...
        {
            var query = new FuzzyQuery(new Term("Name", searchQuery));
            return query;
        }
        ...
        public static void Initialize() {
            ...
            //SampleDataRepository.LoadFromDb(t => LuceneSearch.AddUpdateLuceneIndex(new SampleData { Id=t.Id, Name=t.Name, Description="" }));
            Console.WriteLine("Finished Loading Index");
            //AddUpdateLuceneIndex(SampleDataRepository.GetAll());
        }
    }
}
